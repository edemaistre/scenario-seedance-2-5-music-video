...
Public GitHub repository: https://github.com/edemaistre/scenario-seedance-2-5-music-video
...
Requirements: Python 3.11 or newer, FFmpeg and FFprobe, an authenticated Scenario MCP, and authorized source media. Refresh the live Scenario schema before production because the dated local contract is a guardrail, not the source of truth.
...
The pre-release implementation passed 86 core tests. This release adds 5 documentation and publication contract tests, for 91 total. The suite covers analysis, exact Decimal frame math, manifest validation, race-free assembly, audio provenance, portability, privacy, and forward-facing contracts.
...
- `scripts/`: deterministic analysis, validation, assembly, and delivery verification.
