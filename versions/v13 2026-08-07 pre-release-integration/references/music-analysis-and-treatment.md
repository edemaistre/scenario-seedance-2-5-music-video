...
3. If lyrics are absent, upload an analysis copy and use Scenario `model_scenario-audio-to-text`. Refresh its live schema first. Preserve its segment-level timing and mark uncertain words, language, and speaker interpretation as uncertain.
