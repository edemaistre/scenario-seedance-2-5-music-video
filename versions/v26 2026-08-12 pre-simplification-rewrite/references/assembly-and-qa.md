...
- [Prepare the local project](#prepare-the-local-project)
- [Lock the exact EDL](#lock-the-exact-edl)
- [Assemble silent visuals, then mux once](#assemble-silent-visuals-then-mux-once)
- [Master-audio policy](#master-audio-policy)
- [Verify programmatically](#verify-programmatically)
- [Creative review](#creative-review)
- [Audio and sync review](#audio-and-sync-review)
- [Rights, safety, and release review](#rights-safety-and-release-review)
