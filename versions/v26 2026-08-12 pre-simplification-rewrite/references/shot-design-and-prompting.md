...
- [Start from the locked timeline](#start-from-the-locked-timeline)
- [Use a hybrid coverage plan](#use-a-hybrid-coverage-plan)
- [Evidence from creator prompts](#evidence-from-creator-prompts)
- [Build a reference map](#build-a-reference-map)
- [Match modes to edit needs](#match-modes-to-edit-needs)
- [Write each prompt as a compact director brief](#write-each-prompt-as-a-compact-director-brief)
- [Time correctly](#time-correctly)
- [Create music-video energy without a house style](#create-music-video-energy-without-a-house-style)
- [Diagnose before rerolling](#diagnose-before-rerolling)
