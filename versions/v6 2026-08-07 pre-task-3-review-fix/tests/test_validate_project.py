...
class ValidateProjectTests(unittest.TestCase):
    ...
    def test_requires_supplied_pack_or_approved_generated_pack(self) -> None:
        ...
        supplied["reference_pack"] = {
            "source": "supplied",
            "assets": [{"id": "artist", "path": "references/artist.png", "scenario_asset_id": "asset_i", "roles": ["performer"]}],
        }
        generated = valid_manifest(Decimal("30"))
        generated["reference_pack"] = {
            "source": "generated",
            "approval": "approved",
            "assets": [{"id": "world", "path": "references/world.png", "scenario_asset_id": "asset_w", "roles": ["world"]}],
        }
