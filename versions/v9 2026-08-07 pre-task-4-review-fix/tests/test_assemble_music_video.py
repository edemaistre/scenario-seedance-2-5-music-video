...
class AssembleMusicVideoTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls._make_clip(cls.first_clip, "red", 5, "yellow", 15, 330)
        cls._make_clip(cls.second_clip, "blue", 2, "cyan", 18, 550)
    ...
    @classmethod
    def _make_master(cls, path: Path, codec: str, duration: int = 30) -> None:
        arguments = [
            "ffmpeg",
            "-v",
            "error",
